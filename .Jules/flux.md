...
## 2026-02-20 - [Budget Bucket Actions Trap] **Squeeze:** On mobile, the Edit/Delete buttons in `BudgetBucketCard` transactions were tiny (`icon-sm`, ~22px) and placed side-by-side, creating a "Fat Finger" trap. **Reflow:** Replaced them with a single "More" button that opens a touch-friendly Bottom Drawer with large, full-width actions.
