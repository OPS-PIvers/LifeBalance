      ...
      <div className="w-full">
        ...
        <div className="relative">
          ...
          <input
            ...
            className={cn(
              "w-full p-3 bg-slate-50/50 hover:bg-white focus:bg-white backdrop-blur-sm border border-slate-200/50 rounded-xl outline-none focus:border-brand-500 focus:ring-4 focus:ring-brand-500/10 transition-all shadow-sm placeholder:text-slate-400 disabled:opacity-50 disabled:bg-slate-50",
              icon && "pl-10",
