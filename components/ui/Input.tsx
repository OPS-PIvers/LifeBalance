      ...
      <div className="w-full">
        {hasHeader && (
          <div className="flex justify-between items-end mb-1.5">
            {label ? (
              <label
                htmlFor={inputId}
                className="text-sm font-medium text-slate-700 tracking-tight block"
              >
                {label}
        ...
        <div className="relative">
          ...
          <input
            ...
            className={cn(
              "w-full p-3 bg-white/80 backdrop-blur-sm border border-slate-200/60 hover:border-slate-300 rounded-xl outline-none focus:border-brand-500 focus:ring-4 focus:ring-brand-500/10 transition-all shadow-sm placeholder:text-slate-400 disabled:opacity-50 disabled:bg-slate-50",
              icon && "pl-10",
