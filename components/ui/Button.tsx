...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', layout = 'horizontal', isLoading, leftIcon, rightIcon, children, disabled, ...props }, ref) => {
    const variants = {
      ...
      danger: 'bg-money-bgNeg text-money-neg border border-money-neg/30 hover:bg-money-neg/10 dark:bg-money-neg/15 dark:text-red-300 dark:border-money-neg/40 dark:hover:bg-money-neg/25',
      ...
      'ghost-danger': 'bg-transparent text-money-neg hover:text-money-neg hover:bg-money-bgNeg dark:text-red-400 dark:hover:text-red-300 dark:hover:bg-money-neg/15',
      'ghost-destructive': 'bg-transparent text-brand-400 hover:text-money-neg hover:bg-money-bgNeg dark:text-brand-500 dark:hover:text-red-300 dark:hover:bg-money-neg/15',
