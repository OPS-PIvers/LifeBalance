      ...
      <div className="w-full">
        ...
        <div className="relative">
          ...
          <select
            ...
            className={cn(
              "w-full p-3 bg-slate-50/50 hover:bg-white focus:bg-white border border-slate-200/50 rounded-xl outline-none focus:border-brand-500 focus:ring-4 focus:ring-brand-500/10 transition-all shadow-sm disabled:opacity-50 disabled:bg-slate-50 appearance-none text-slate-900",
              icon ? "pl-10" : "pl-3",
