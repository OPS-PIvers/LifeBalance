          ...
          >
             ...
             {title && (
               <div className="px-4 py-3 flex items-center justify-between border-b border-brand-200 dark:border-brand-700 shrink-0">
                 ...
                 <button onClick={onClose} className="p-2.5 min-w-11 min-h-11 flex items-center justify-center text-brand-400 hover:text-brand-600 rounded-full hover:bg-brand-100 dark:text-brand-450 dark:hover:text-brand-200 dark:hover:bg-brand-700" aria-label="Close drawer" disabled={disableClose}>
                   <X size={20} />
                 </button>
               </div>
             )}
