...
/**
 * The canonical micro-caps eyebrow / section label: one size (text-xs), weight
 * (font-semibold), case (uppercase) and tracking (tracking-wider), with color as
 * the only variant. Replaces the several different hand-spellings of this label
 * scattered across the app (varying text-xs/xxs, font-semibold/bold, and
 * with/without font-display) — see the UI 10x audit.
 */
