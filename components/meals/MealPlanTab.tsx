  ...
  return (
    <div className="space-y-6 pb-20">
      ...
      <div className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-glass ring-1 ring-black/5 p-6 flex flex-col items-center gap-4">
        ...
        <div className="flex gap-3 w-full sm:w-auto">
            <button
                ...
                className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-4 py-2 bg-white ring-1 ring-black/5 text-slate-600 rounded-full text-xs font-bold uppercase tracking-wide hover:bg-slate-50 transition-all shadow-sm"
            >
            ...
            <button
                ...
                className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-4 py-2 bg-slate-900 text-white ring-1 ring-black/5 rounded-full text-xs font-bold uppercase tracking-wide hover:bg-slate-800 transition-all shadow-lg shadow-slate-200"
            >
      ...
      <div className="space-y-4">
        {weekDays.map(day => {
            ...
            return (
                <div
                    key={dateStr}
                    className={`bg-white/60 backdrop-blur-md rounded-2xl shadow-soft p-6 ring-1 ring-black/5 ${isToday ? 'ring-brand-200 bg-brand-50/30' : ''}`}
                >
                    <div className="flex flex-col sm:flex-row gap-4">
                        {/* Date Column */}
                        <div className="min-w-[80px] shrink-0 flex sm:flex-col items-center sm:items-start justify-between sm:justify-start">
                            <div>
                                <div className="text-2xl font-semibold tracking-tight text-slate-900 leading-none">{format(day, 'd')}</div>
                            ...
                            <button
                                ...
                                className="sm:mt-3 flex items-center gap-1.5 text-xs font-bold text-slate-600 bg-slate-100 hover:bg-slate-200 px-3 py-1.5 rounded-full transition-colors"
                            >
                        ...
                        <div className="flex-1 space-y-3 pt-2 sm:pt-0">
                            {planItems.length > 0 ? planItems.map((planItem) => {
                                ...
                                return (
                                    <div key={planItem.id} className="group bg-white/80 backdrop-blur-sm ring-1 ring-black/5 rounded-xl p-4 shadow-sm hover:shadow-glass hover:bg-white transition-all flex justify-between items-start gap-3">
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <div className="font-medium tracking-tight text-slate-900 truncate pr-2">{mealName}</div>

                                            {linkedMeal?.description && (
                                                <div className="text-sm text-slate-500 leading-relaxed mt-1 line-clamp-1">{linkedMeal.description}</div>
                                            )}
                                            ...
                                            {linkedMeal?.ingredients && linkedMeal.ingredients.length > 0 && (
                                                <button
                                                    ...
                                                    className="mt-2 text-xxs font-medium text-slate-500 flex items-center gap-1 hover:text-slate-900 transition-colors"
                                                >
                                        ...
                                        <div className="flex flex-row sm:flex-col gap-1 opacity-100 sm:opacity-0 sm:group-hover:opacity-100 focus-within:opacity-100 transition-opacity">
                                            <button
                                                ...
                                                className="p-3 sm:p-1.5 text-slate-400 hover:text-slate-900 hover:bg-slate-100 rounded-lg transition-colors active:scale-95"
                                            ...
                                            <button
                                                ...
                                                className="p-3 sm:p-1.5 text-slate-400 hover:text-red-600 hover:bg-red-50 rounded-lg transition-colors active:scale-95"
                                ...
                                <div
                                    onClick={() => handleAddMealToDate(day)}
                                    className="border-2 border-dashed border-slate-200/50 rounded-xl p-4 text-center cursor-pointer hover:border-slate-300 hover:bg-slate-50 transition-all group"
                                >
      ...
      {isAddModalOpen && (
          ...
          >
              <div className="bg-white rounded-2xl w-full max-w-lg max-h-[calc(100dvh-10rem)] sm:max-h-[80vh] flex flex-col overflow-hidden shadow-2xl ring-1 ring-black/5 animate-in zoom-in-95 duration-200">
                  ...
                  <div className="flex-1 overflow-y-auto p-6 space-y-6">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                          <button
                              ...
                              className="flex items-center justify-center gap-2 py-3 px-4 bg-white text-slate-700 rounded-xl hover:bg-slate-50 font-medium text-sm transition-colors ring-1 ring-black/5 shadow-sm"
                          >
                              <ChefHat className="w-4.5 h-4.5 text-blue-500" /> Cookbook
                          </button>
                          <button
                              onClick={() => setIsAIModalOpen(true)}
                              className="flex items-center justify-center gap-2 py-3 px-4 bg-white text-slate-700 rounded-xl hover:bg-slate-50 font-medium text-sm transition-colors ring-1 ring-black/5 shadow-sm"
                          >
                              <Sparkles className="w-4.5 h-4.5 text-purple-500" /> AI Suggest
                          </button>
                      </div>
                      ...
                      <div className="space-y-5">
                          <div>
                              ...
                              <input
                                  ...
                                  className="w-full p-3 bg-slate-50 border-0 rounded-xl focus:ring-2 focus:ring-slate-200 transition-all outline-none font-medium placeholder:text-slate-400 text-slate-900"
                          ...
                          <div>
                              ...
                              <textarea
                                  ...
                                  className="w-full p-3 bg-slate-50 border-0 rounded-xl focus:ring-2 focus:ring-slate-200 transition-all outline-none text-sm placeholder:text-slate-400 text-slate-600 leading-relaxed"
                                  rows={2}
                          ...
                          <div>
                              ...
                              <textarea
                                  ...
                                  className="w-full p-3 bg-slate-50 border-0 rounded-xl focus:ring-2 focus:ring-slate-200 transition-all outline-none text-sm font-mono placeholder:text-slate-400 text-slate-600"
                                  rows={4}
                                  placeholder="Step 1...&#10;Step 2..."
                              />
                          </div>
                          ...
                          <div>
                              ...
                              <input
                                  ...
                                  className="w-full p-3 bg-slate-50 border-0 rounded-xl focus:ring-2 focus:ring-slate-200 transition-all outline-none text-sm text-blue-600 placeholder:text-slate-400"
                              ...
                              <div className="flex flex-wrap gap-2">
                                  ...
                                  <div className="relative flex-1 min-w-[140px]">
                                      <input
                                          ...
                                          className="w-full py-1.5 pl-3 pr-8 rounded-full bg-slate-50 border-0 text-xs focus:ring-2 focus:ring-slate-200 outline-none text-slate-700 placeholder:text-slate-400"
                                          onKeyDown={e => e.key === 'Enter' && (e.preventDefault(), handleAddTag())}
                                      />
                                      <button
                                          onClick={handleAddTag}
                                          disabled={!tagInput.trim()}
                                          className="absolute right-1 top-1/2 -translate-y-1/2 p-1 bg-white shadow-sm rounded-full text-slate-600 disabled:opacity-50 hover:bg-slate-50 ring-1 ring-black/5"
                                          aria-label="Add custom tag"
                                      >
                      ...
                      <div>
                           ...
                           {currentMeal.ingredients && currentMeal.ingredients.length > 0 && (
                               <div className="mb-4 flex flex-wrap gap-2">
                                   {currentMeal.ingredients.map((ing, idx) => (
                                       <div key={idx} className="flex items-center gap-2 px-3 py-1.5 bg-white ring-1 ring-black/5 rounded-lg text-sm shadow-sm">
                                           <span className="font-medium text-slate-700">{ing.name}</span>
                                           <span className="text-slate-500 text-xs bg-slate-50 px-1.5 py-0.5 rounded">{ing.quantity}</span>
                                           <button
                                               onClick={() => {
                                                   setCurrentMeal(prev => ({
                                                       ...prev,
                           ...
                           <div className="space-y-4">
                               {/* Ingredient Entry */}
                               <div className="bg-white p-4 rounded-xl ring-1 ring-black/5 shadow-sm">
                                    ...
                                    <div className="flex gap-2">
                                        <input
                                            ...
                                            className="flex-1 rounded-xl border-0 bg-slate-50 text-sm focus:ring-2 focus:ring-slate-200 outline-none p-2.5 placeholder:text-slate-400 text-slate-700"
                                        ...
                                        <input
                                            ...
                                            type="text"
                                            placeholder="Qty"
                                            className="w-20 rounded-xl border-0 bg-slate-50 text-sm focus:ring-2 focus:ring-slate-200 outline-none p-2.5 placeholder:text-slate-400 text-slate-700"
                                            value={ingredientQty}
                  ...
                  <div className="p-4 border-t border-slate-100 bg-white flex flex-col gap-2 shrink-0">
                      ...
                      <div className="flex gap-3 w-full">
                        ...
                        <button
                            ...
                            className="flex-1 py-3 bg-slate-900 text-white font-bold rounded-xl shadow-lg hover:bg-slate-800 transition-all active:scale-95 ring-1 ring-black/5"
                        >
      ...
      {isPreviousMealsModalOpen && (
          ...
          >
               <div className="bg-white rounded-2xl w-full max-w-md p-6 max-h-[80vh] flex flex-col shadow-2xl ring-1 ring-black/5 animate-in zoom-in-95 duration-200">
                   <h3 id="previous-meals-title" className="text-xl font-semibold tracking-tight text-slate-900 mb-4">Your Cookbook</h3>
                       ...
                       {meals.sort((a,b) => a.name.localeCompare(b.name)).map(meal => (
                           <div key={meal.id} className="flex items-stretch gap-2">
                               <button
                                    ...
                                    className="flex-1 text-left p-4 hover:bg-slate-50 rounded-xl ring-1 ring-slate-100 flex justify-between items-center group transition-colors"
                               >
                                   <span className="font-medium text-slate-700 group-hover:text-slate-900">{meal.name}</span>
                                   <ChevronRight className="w-4 h-4 text-slate-300 group-hover:text-slate-500" />
                               </button>
                               <button
                                    onClick={() => handleCloneMeal(meal)}
                                    className="px-4 text-slate-400 hover:text-slate-600 hover:bg-slate-50 ring-1 ring-slate-100 rounded-xl transition-colors"
                                    title="Clone Meal"
                               >
      ...
      {isAIModalOpen && (
          ...
          >
              <div className="bg-white rounded-2xl w-full max-w-sm p-6 shadow-2xl ring-1 ring-black/5 animate-in zoom-in-95 duration-200">
                  <h3 id="ai-modal-title" className="text-xl font-semibold tracking-tight mb-6 flex items-center gap-2 text-slate-900">
                      <Sparkles className="text-purple-600 w-6 h-6" /> Chef AI
                  </h3>

                  <div className="space-y-3 mb-8">
                      <label className="flex items-center gap-3 p-4 ring-1 ring-black/5 rounded-xl cursor-pointer hover:bg-slate-50 transition-all">
                          <input
                              type="checkbox"
                          ...
                          />
                          <div>
                              <div className="font-medium text-slate-900">Budget Friendly</div>
                              <div className="text-xs text-slate-500 mt-0.5">Low cost ingredients</div>
                          </div>
                      </label>

                      <label className="flex items-center gap-3 p-4 ring-1 ring-black/5 rounded-xl cursor-pointer hover:bg-purple-50 hover:ring-purple-200 transition-all">
                          <input
                              type="checkbox"
                          ...
                          />
                          <div>
                              <div className="font-medium text-slate-900">Quick & Easy</div>
                      ...
                      <label className="flex items-center gap-3 p-4 ring-1 ring-black/5 rounded-xl cursor-pointer hover:bg-purple-50 hover:ring-purple-200 transition-all">
                          ...
                          />
                          <div>
                              <div className="font-medium text-slate-900">Try Something New</div>
