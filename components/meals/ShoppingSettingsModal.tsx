                          ...
                          <div className="flex-1 space-y-2 mr-2">
                            ...
                            <div className="flex gap-2">
                              <Input
                                ...
                                className="h-9 py-1"
                              />
                              <Button size="icon-sm" variant="ghost" onClick={handleUpdateStore} aria-label="Save store name">
                                <Save className="w-4 h-4 text-green-600"/>
                              </Button>
                              <Button size="icon-sm" variant="ghost" onClick={() => setEditingStoreId(null)} aria-label="Cancel editing">
            ...
            <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
                ...
                <div className="flex gap-2">
                    ...
                    <Button
                        ...
                        leftIcon={<Plus className="w-4 h-4" />}
                    >
                      {/* Icon only on mobile maybe? kept text hidden in original? No, it was just icon */}
                    </Button>
                </div>
            </div>
            ...
            <div className="space-y-2">
                <div className="flex items-center justify-between pl-1">
                      ...
                      <Button
                        ...
                        className="text-brand-600 hover:text-brand-700 h-auto p-0 hover:bg-transparent"
                      >
            ...
            {!editingTemplate ? (
              <>
                <Button
                  ...
                  className="w-full py-8 text-gray-500 hover:text-brand-600 hover:bg-brand-50"
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                    ...
                    <Button variant="ghost" size="icon-sm" onClick={() => setEditingTemplate(null)} aria-label="Close">
                ...
                <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100 space-y-3">
                  ...
                  {itemSearch.trim() && !groceryCatalog.some(i => i.name.toLowerCase() === itemSearch.trim().toLowerCase()) && (
                      <Button
                          ...
                          className="w-full justify-start text-brand-700 hover:bg-brand-50 hover:border-brand-300"
                          leftIcon={<Plus className="w-4 h-4" />}
                      >
