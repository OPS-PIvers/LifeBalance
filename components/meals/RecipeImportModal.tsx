      ...
      <div className="flex flex-col h-full">
        ...
        <div className="px-6 py-4 border-b border-slate-100 flex justify-between items-center bg-white z-10 shrink-0">
          <div className="flex items-center gap-2">
            ...
            <div>
                <h3 className="text-lg font-bold text-slate-900 tracking-tight">Import Recipe</h3>
                <p className="text-xs text-slate-500 font-medium">Paste text from any website</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6 space-y-4 flex-1 overflow-y-auto">
             <div className="bg-slate-50 border border-slate-200 rounded-xl p-4">
                 <div className="flex gap-3">
                     ...
                     <div>
                         <p className="text-sm font-semibold text-slate-900">AI Recipe Parser</p>
