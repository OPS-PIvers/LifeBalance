...
const HabitCard: React.FC<HabitCardProps> = ({ habit, dragHandle }) => {
  ...
  const [modalType, setModalType] = useState<'edit' | 'duplicate' | null>(null);
  ...
  return (
    <>
      ...
      <HabitFormModal
        isOpen={modalType === 'edit' || modalType === 'duplicate'}
        onClose={() => setModalType(null)}
        editingHabit={modalType === 'edit' ? habit : undefined}
        initialValues={modalType === 'duplicate' ? {
          ...habit,
