    ...
    <>
      <div className={containerClasses}>
        ...
        <button
          ...
          className="absolute inset-0 w-full h-full cursor-pointer focus:outline-none focus:ring-2 focus:ring-brand-400 focus:ring-offset-2 rounded-card z-10"
          aria-label={`Toggle habit: ${habit.title}, current count: ${habit.count}`}
          tabIndex={0}
        />
        
        {/* ACTION INDICATOR */}
        <div className="flex-shrink-0 mr-4 relative group pointer-events-none z-20">
        ...
        {/* CONTENT */}
        <div className="flex-1 min-w-0 pointer-events-none z-20">
          <div className="flex justify-between items-start">
            ...
            <div className="flex items-center gap-1 -mr-2 relative z-30">
              {dragHandle && (
        ...
        {isMenuOpen && (
          <>
            ...
            />
            <div
              className="absolute top-10 right-2 bg-white rounded-xl shadow-xl border border-brand-100 py-1 min-w-[120px] animate-in fade-in zoom-in-95 duration-100 z-50"
              role="menu"
