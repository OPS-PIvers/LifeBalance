    ...
    <div className="p-6 space-y-5">
      ...
      <div>
        <label className="text-xs font-bold text-brand-400 dark:text-brand-400 uppercase mb-2 block">
          Effort Level <span className="font-normal text-brand-300 dark:text-brand-500">(determines points)</span>
        </label>
      ...
      {editingHabit && onDelete && (
        <button
          ...
          className="w-full py-3 text-money-neg font-semibold rounded-card border border-money-neg/30 dark:border-money-neg/40 hover:bg-money-bgNeg dark:hover:bg-money-neg/15 transition-colors flex items-center justify-center gap-2"
