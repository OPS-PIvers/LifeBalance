 ...
 * Fixed just above the BottomNav, like `OfflineBanner` — but offset ABOVE
 * OfflineBanner's own slot (not stacked in the identical position/z-index),
 * since both can render at once (offline at a saved location) and would
 * otherwise fully overlap. OfflineBanner is a single text-xs line with
 * py-2 + a 1px border (~2.5rem tall); this banner sits that far further up.
 */
