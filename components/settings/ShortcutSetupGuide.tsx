...
const ShortcutSetupGuide: React.FC = () => {
  ...
  const examples: ShortcutExample[] = [
    ...
    },
    {
      ...
      isAutomation: true,
      automationNote: 'The Transaction trigger automatically provides Amount and Merchant as variables. The API accepts positive or negative amounts in any of these formats: 50, -50, "$50.00", "-$50.00". Both signs work correctly regardless of your iOS version. When adding body fields, tap the value field and select the matching variable from the list above the keyboard.',
    },
  ];
