        ...
        <div className="space-y-1">
          {(['habit', 'expense', 'shopping'] as const).map((endpoint) => (
            <button
              ...
              className="w-full flex items-center justify-between px-2 py-1.5 bg-white rounded border border-slate-100 hover:bg-slate-50 text-left"
            >
      ...
      {revokedKeys.length > 0 && (
        <div className="space-y-2">
          ...
          {revokedKeys.map((key) => (
            <div
              key={key.id}
              className="bg-slate-50 border border-slate-200 rounded-xl p-3 opacity-60"
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
