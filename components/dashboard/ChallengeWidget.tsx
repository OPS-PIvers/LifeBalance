...
export const ChallengeWidget: React.FC<ChallengeWidgetProps> = ({ onOpenModal }) => {
  ...
  return (
    <div
      ...
      role="button"
      tabIndex={0}
      aria-label={`View ${activeChallenge.title} Details`}
      className="bg-gradient-to-br from-brand-800 to-indigo-900 rounded-2xl p-5 text-white shadow-lg relative overflow-hidden cursor-pointer active:scale-[0.98] transition-transform focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500"
    >
