          ...
          {loading ? (
            ...
            <>
                  ...
                  <div className="border rounded-xl overflow-hidden">
                    ...
                    <div className="divide-y">
                        {households.map(h => {
                            ...
                            return (
                                <div key={h.id} className="p-4 flex items-center justify-between hover:bg-slate-50">
                                    <div>
              ...
              {activeTab === 'reports' && (
                <div className="space-y-4">
                    {reports.map(report => (
                        <div key={report.id} className="p-4 rounded-xl border border-slate-200 hover:shadow-md transition-shadow">
                            <div className="flex justify-between items-start mb-2">
                                <div>
                                    <span className="text-xs font-mono bg-slate-100 px-2 py-1 rounded text-slate-600 font-bold">{report.version}</span>
