...
const PointsBreakdownModal: React.FC<PointsBreakdownModalProps> = ({
  ...
  return (
    ...
    >
              ...
              >
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h3 className="font-semibold tracking-tight text-slate-800">{item.title}</h3>
      ...
      <div className="sticky bottom-0 p-6 border-t border-slate-100 bg-slate-50 text-center text-xs text-slate-400">
