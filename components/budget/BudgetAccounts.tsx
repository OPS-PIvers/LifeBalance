...
const BudgetAccounts: React.FC = () => {
  ...
  const renderAccountCard = (account: Account, isLiabilityGroup: boolean) => {
    ...
    return (
      <div
        ...
        className={`bg-white/80 backdrop-blur-xl p-6 rounded-3xl border border-white/20 ring-1 ring-black/5 shadow-glass relative overflow-hidden transition-all duration-200 ${
  ...
  return (
    <div className="space-y-6">
      {/* Net Worth Header */}
      <div className="bg-slate-900 rounded-3xl p-8 text-white shadow-glass ring-1 ring-white/10 relative overflow-hidden text-center">
