...
describe('BudgetCalendar', () => {
  ...
  it('navigates between months', () => {
    // Set a safe date to avoid end-of-month edge cases (e.g. Jan 31 -> Feb 28 vs March 1)
    // Javascript's setMonth overflows (Jan 31 -> March 2/3), while date-fns clamps (Jan 31 -> Feb 28/29)
    vi.useFakeTimers();
