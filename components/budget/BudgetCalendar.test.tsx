...
describe('BudgetCalendar', () => {
  ...
  it('navigates between months', () => {
    // FIX: Set system time to mid-month to avoid end-of-month overflow issues
    // Native Date.setMonth() overflows (e.g. Jan 31 + 1 month -> Mar 3),
    // while date-fns (used in component) clamps (Jan 31 + 1 month -> Feb 28).
    vi.useFakeTimers();
