  ...
  return (
    <div className="space-y-4 pb-24 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      {historyGroups.length === 0 ? (
        ...
        return (
          <Card key={group.periodId} className="overflow-hidden ring-1 ring-black/5 shadow-glass bg-white/80 backdrop-blur-xl rounded-2xl">
            <button
              onClick={() => toggleExpand(group.periodId)}
              className="w-full text-left"
            >
              <div className="p-5 bg-transparent hover:bg-white/50 transition-colors">
            ...
            {isExpanded && (
              <div className="bg-slate-50/50 p-4 border-t border-slate-100 space-y-3">
                ...
                {group.snapshots.sort((a, b) => (b.limit - b.totalSpent) - (a.limit - a.totalSpent)).map(bucket => {
                  ...
                  return (
                    <div key={bucket.id} className="bg-white/80 p-4 rounded-xl ring-1 ring-black/5 shadow-sm">
                      <div className="flex justify-between items-center mb-2">
