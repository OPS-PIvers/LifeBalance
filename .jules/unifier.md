...
## 2025-02-18 - [Button Shadow Standardization] **Drift:** Complex, hardcoded shadow strings in Button.tsx for different variants. **Fix:** Extracted semantic shadow tokens (btn-primary, btn-success, etc.) to tailwind.config.js.
